...
def sumProb(N,p):
    ''' Hàm sumProb(N,p) tính giá trị tổng xác suất của các symbol từ 0 đến N cho nguồn có các symbol theo phân bố binomial 
    ...
    return result
# print(sumProb(500,0.6))

def approxEntropy(N,p):
    '''
    Hàm approxEntropy(N, p) tính giá trị trung bình lượng tin của tất cả symbol từ 0 đến N
    với N là tổng số phép thử
